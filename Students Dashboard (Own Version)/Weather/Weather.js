...
const apiKey = "70e1915b0f5e358e51d60c09c37d8d2f"
...
form.addEventListener('submit', e => {
	...
	fetch(url)
		.then(response => response.json()) // => is function(), so instead of function(), () => is shorter.
		.then(data => {
			...
			const markup = `
				...
				<div>
					<h4 id="temperature-number">${Math.round(main.temp)}<sup>°C</sup></h4>
